const translations = {
  en: {
    ...
    footerText: "Educational concept demo • A mini experience to spark curiosity about DIN",
  ...
  tr: {
    navPlay: "Oyuna Geç",
    eyebrow: "Standartlar = Güven + Düzen + Kolaylık",
    heroTitle: "DIN nedir? Günlük hayatta neden önemlidir?",
    heroLead:
      "DIN, ürünlerin daha güvenli, anlaşılır ve uyumlu olmasına yardımcı olan standartlar geliştirir. Bu siteyle DIN'i keşfet, sonra mini oyunda yanlış etiketleri yakala!",
    startGame: "Oyunu Başlat",
    learnMore: "Önce Öğren",
    badge1: "10-18 yaş için",
    badge2: "Mini oyunlu öğrenme",
    badge3: "TR / DE destekli",
    visualCaption: "Kontrol ediliyor...",
    whatIsDinTitle: "DIN ne yapar?",
    whatIsDinText:
      "DIN (Deutsches Institut für Normung), birçok alanda standartlar geliştirerek ürünlerin ve bilgilerin daha anlaşılır, güvenli ve uyumlu olmasına katkı sağlar.",
    kp1: "Aynı sembol ve işaretlerin herkesçe anlaşılmasını destekler.",
    kp2: "Güvenlik ve kaliteyi güçlendiren ortak kurallar sağlar.",
    kp3: "Günlük yaşamda karışıklığı azaltır.",
    dailyLifeTitle: "Günlük hayatta DIN etkisi",
    cardSafetyTitle: "Güvenlik",
    cardSafetyText: "Uyarılar, semboller ve ölçüler daha net olur.",
    cardFitTitle: "Uyumluluk",
    cardFitText: "Parçalar ve bilgiler birlikte daha iyi çalışır.",
    cardClarityTitle: "Anlaşılırlık",
    cardClarityText: "Etiketler ve işaretler daha kolay okunur.",
    exampleTitle: "Nerelerde görürüz?",
    ex1: "Ürün etiketlerinde içerik ve uyarı bilgileri",
    ex2: "Teknik çizimler ve ölçülendirmeler",
    ex3: "Güvenlik işaretleri ve semboller",
    ex4: "Okul, laboratuvar ve üretim alanlarındaki düzen",
    gameEyebrow: "Mini Oyun",
    gameTitle: "Yanlış Etiketi Yakala",
    gameSubtitle: "Amaç: Sarı torbayı sağ-sol ok tuşlarıyla hareket ettir ve hatalı etiketli şişeleri yakala.",
    startRound: "Başlat",
    resetRound: "Sıfırla",
    scoreLabel: "Puan",
    timeLabel: "Süre",
    comboLabel: "Seri",
    arenaHint: "Başlat'a bas, sarı torbayı sağ-sol oklarla hareket ettir ve düşen şişeleri ayıkla.",
    rulesTitle: "Kurallar",
    rule1: "Hatalı etiketi sarı torbada yakala: +10 puan",
    rule2: "Doğru etiketi yanlış yakala: -5 puan",
    rule3: "Hatalı etiketi kaçırma: -8 puan",
    rule4: "Sarı torbayı sağ-sol ok tuşlarıyla hareket ettir",
    factTitle: "DIN Bilgisi",
    factDefault: "Standartlar, farklı insanların aynı bilgiyi aynı şekilde anlamasına yardımcı olur.",
    legendTitle: "İşaretler",
    legendGood: "Düzenli / doğru etiket",
    legendBad: "Hatalı / eksik etiket",
    resultEyebrow: "Tur Tamamlandı",
    resultTitleDefault: "Standart Avcısı!",
    playAgain: "Tekrar Oyna",
    footerText: "Eğitim amaçlı hazırlanmış tanıtım konsepti • DIN hakkında merak uyandırmak için mini deneyim",
    ariaGood: "Doğru etiketli ürün",
    ariaBad: "Yanlış etiketli ürün",
    scorePopupPlus: "+{value}",
    scorePopupMinus: "{value}",
    comboBonusText: "Bonus Seri +{value}",
    factEventGood: "Harika! Hatalı etiketi yakaladın. Standartlar, yanlış bilgi riskini azaltmaya yardımcı olur.",
    factEventBadClick: "Dikkat! Doğru etiketli bir şişeyi sarı torbaya aldın. Bu oyunda hatalı olanları yakalamalısın.",
    factEventMissBad: "Kaçırdın! Eksik veya karışık etiketler güvenlik ve anlaşılırlık sorununa yol açabilir.",
    factEventCombo: "Süper seri! Düzenli kontrol yapmak kalite denetiminde çok önemlidir.",
    factEventStart: "Tur başladı. Sarı torbayı hareket ettir ve sadece hatalı etiketleri yakala.",
    resultScoreText: "Toplam puanın: {score}",
    resultGradeLow: "Başlangıç seviyesi dedektif. Etiketleri biraz daha dikkatli incele.",
    resultGradeMid: "İyi iş! Standart mantığını anlamaya başladın.",
    resultGradeHigh: "Çok iyi! Etiket hatalarını hızlıca fark ettin.",
    resultGradeTop: "Mükemmel! Gerçek bir DIN Dedektifisin.",
    resultMoodLow: "Bir sonraki turda daha çok hata yakalayabilirsin. Devam!",
    resultMoodMid: "Güzel tempo! Dikkatin giderek güçleniyor.",
    resultMoodHigh: "Süper performans! Hızlı ve dikkatli oynadın.",
    resultMoodTop: "Kutlama zamanı! Etiket hatalarını adeta taradın.",
    resultTitleLow: "Yeni Başlayan Dedektif",
    resultTitleMid: "Dikkatli Göz",
    resultTitleHigh: "Standart Avcısı",
    resultTitleTop: "DIN Ustası",
    toggleInfoShow: "Bilgi Panelini Aç",
    toggleInfoHide: "Bilgi Panelini Gizle",
    factList: [
      "Standartlar, ürün etiketlerinde bilgilerin daha tutarlı verilmesini destekler.",
      "Aynı sembolün herkes tarafından benzer şekilde anlaşılması güvenliği artırır.",
      "Ölçü ve formatlarda uyum, üretimde ve kullanımda hataları azaltabilir.",
      "DIN birçok farklı sektörde ortak dil oluşturmaya yardımcı olur."
    ]
  },
  de: {
    navPlay: "Zum Spiel",
    ...
    heroLead:
      "DIN entwickelt Standards, damit Produkte sicherer, verständlicher und kompatibler werden. Entdecke DIN auf dieser Seite und fange dann im Mini-Spiel die falschen Etiketten!",
    startGame: "Spiel Starten",
    learnMore: "Erst Lernen",
    badge1: "Für 10-18 Jahre",
    badge2: "Lernen mit Mini-Spiel",
    badge3: "TR / DE verfügbar",
    visualCaption: "Wird geprüft...",
    whatIsDinTitle: "Was macht DIN?",
    whatIsDinText:
      "DIN (Deutsches Institut für Normung) trägt mit Standards dazu bei, dass Produkte und Informationen verständlicher, sicherer und besser kompatibel sind.",
    kp1: "Unterstützt, dass Symbole und Zeichen einheitlich verstanden werden.",
    kp2: "Schafft gemeinsame Regeln für Sicherheit und Qualität.",
    kp3: "Reduziert Verwirrung im Alltag.",
    dailyLifeTitle: "DIN im Alltag",
    cardSafetyTitle: "Sicherheit",
    cardSafetyText: "Warnhinweise, Symbole und Maße werden klarer.",
    cardFitTitle: "Kompatibilität",
    cardFitText: "Teile und Informationen funktionieren besser zusammen.",
    cardClarityTitle: "Verständlichkeit",
    ...
    ex2: "Technische Zeichnungen und Bemaßungen",
    ...
    startRound: "Start",
    resetRound: "Zurücksetzen",
    scoreLabel: "Punkte",
    timeLabel: "Zeit",
    comboLabel: "Serie",
    arenaHint: "Drücke Start, bewege den gelben Sack mit den Pfeiltasten und sortiere die fallenden Flaschen.",
    rulesTitle: "Regeln",
    ...
    factDefault: "Standards helfen, dass verschiedene Menschen Informationen auf ähnliche Weise verstehen.",
    legendTitle: "Hinweise",
    legendGood: "Ordentlich / korrekt etikettiert",
    legendBad: "Fehlerhaft / unvollständig etikettiert",
    resultEyebrow: "Runde beendet",
    resultTitleDefault: "Standard-Jäger!",
    playAgain: "Nochmal spielen",
    footerText: "Lernorientiertes Konzept • Mini-Erlebnis, um Interesse an DIN zu wecken",
    ...
    factEventMissBad: "Verpasst! Unklare oder unvollständige Etiketten können zu Sicherheitsproblemen führen.",
    factEventCombo: "Starke Serie! Regelmäßige Kontrolle ist in der Qualitätssicherung sehr wichtig.",
    ...
    resultMoodLow: "In der nächsten Runde findest du noch mehr Fehler. Weiter so!",
    resultMoodMid: "Gutes Tempo! Dein Blick wird immer schärfer.",
    ...
    resultTitleLow: "Anfänger-Detektiv",
    resultTitleMid: "Scharfer Blick",
    resultTitleHigh: "Standard-Jäger",
    resultTitleTop: "DIN-Profi",
    toggleInfoShow: "Infobereich anzeigen",
    toggleInfoHide: "Infobereich ausblenden",
    factList: [
      "Standards unterstützen eine einheitlichere Darstellung von Informationen auf Etiketten.",
      "Wenn Symbole einheitlich verstanden werden, steigt die Sicherheit.",
      "Kompatible Maße und Formate können Fehler in Nutzung und Produktion verringern.",
